...
**    Modify for vooc batt 4.40   */
	...
	switch (chip->vooc_fw_type) {
		...
		case VOOC_FW_TYPE_STM8S_4450_SVOOC_6500MA_8250:
			...
			break;
		case VOOC_FW_TYPE_STM8S_4400_SVOOC_6500MA_8250_LITE:
			chip->firmware_data = Stm8s_fw_data_4400_svooc_6500MA_8250_lite;
			chip->fw_data_count = sizeof(Stm8s_fw_data_4400_svooc_6500MA_8250_lite);
			chip->fw_data_version = Stm8s_fw_data_4400_svooc_6500MA_8250_lite[chip->fw_data_count - 4];
			break;
		default:
			break;
	}
